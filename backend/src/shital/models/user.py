...
from shital.core.fabrics.models import SoftDeleteMixin, TimestampMixin, UUIDMixin
...
if TYPE_CHECKING:
    ...
    from shital.models.finance import Account, Donation, GiftAidDeclaration, Transaction
    from shital.models.hr import Employee, LeaveRequest, TimeEntry
    from shital.models.notifications import Notification
    from shital.models.payroll import PayrollRun
