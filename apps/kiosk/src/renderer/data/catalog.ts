...
export const SOFT_DONATION_ITEMS: CatalogItem[] = [
  // Grains
  { id: 'rice_10',  name: 'Rice Bag 10kg',          nameGu: 'ચોખા 10kg',        nameHi: 'चावल 10kg',       icon: '🌾', emoji: '🌾', price: 15, category: 'GRAINS', giftAidEligible: false, description: 'White rice bag 10kg',           unit: '10kg',   imageColor: '#FEF3C7', image: 'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=400&h=250&fit=crop&q=80' },
  { id: 'rice_25',  name: 'Rice Bag 25kg',          nameGu: 'ચોખા 25kg',        nameHi: 'चावल 25kg',       icon: '🌾', emoji: '🌾', price: 35, category: 'GRAINS', giftAidEligible: false, description: 'White rice bag 25kg',           unit: '25kg',   imageColor: '#FDE68A', image: 'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=400&h=250&fit=crop&q=80' },
  { id: 'basmati_5',name: 'Basmati Rice 5kg',       nameGu: 'બાસમતી 5kg',       nameHi: 'बासमती 5kg',      icon: '🌾', emoji: '🌾', price: 18, category: 'GRAINS', giftAidEligible: false, description: 'Premium basmati rice 5kg',       unit: '5kg',    imageColor: '#FEF9C3', image: 'https://images.unsplash.com/photo-1536304993881-ff86d42818ef?w=400&h=250&fit=crop&q=80' },
  { id: 'atta_10',  name: 'Atta (Wheat Flour) 10kg',nameGu: 'આટો 10kg',         nameHi: 'आटा 10kg',        icon: '🌿', emoji: '🌿', price: 12, category: 'GRAINS', giftAidEligible: false, description: 'Chapati flour 10kg',            unit: '10kg',   imageColor: '#FEF3C7', image: 'https://images.unsplash.com/photo-1588072432836-e10032774350?w=400&h=250&fit=crop&q=80' },
  { id: 'atta_20',  name: 'Atta 20kg',              nameGu: 'આટો 20kg',         nameHi: 'आटा 20kg',        icon: '🌿', emoji: '🌿', price: 22, category: 'GRAINS', giftAidEligible: false, description: 'Chapati flour 20kg',            unit: '20kg',   imageColor: '#FEF3C7', image: 'https://images.unsplash.com/photo-1588072432836-e10032774350?w=400&h=250&fit=crop&q=80' },
  // Oil & Essentials
  { id: 'sunflower_5l',  name: 'Sunflower Oil 5L',      nameGu: 'સૂર્યમુખી તેલ 5L', nameHi: 'सूरजमुखी तेल 5L', icon: '🌻', emoji: '🌻', price: 8,  category: 'OIL_ESSENTIALS', giftAidEligible: false, description: 'Pure sunflower oil 5 litres',     unit: '5L',     imageColor: '#FEF08A', image: 'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=400&h=250&fit=crop&q=80' },
  { id: 'mustard_5l',    name: 'Mustard Oil 5L',        nameGu: 'સરસવ તેલ 5L',     nameHi: 'सरसों का तेल 5L',  icon: '🌼', emoji: '🌼', price: 9,  category: 'OIL_ESSENTIALS', giftAidEligible: false, description: 'Pure mustard oil 5 litres',       unit: '5L',     imageColor: '#FEF08A', image: 'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=400&h=250&fit=crop&q=80' },
  { id: 'sugar_5',       name: 'Sugar 5kg',             nameGu: 'ખાંડ 5kg',         nameHi: 'चीनी 5kg',        icon: '🍬', emoji: '🍬', price: 6,  category: 'OIL_ESSENTIALS', giftAidEligible: false, description: 'White granulated sugar 5kg',     unit: '5kg',    imageColor: '#F9FAFB', image: 'https://images.unsplash.com/photo-1559181567-c3190ca9959b?w=400&h=250&fit=crop&q=80' },
  { id: 'salt_2',        name: 'Salt 2kg',              nameGu: 'મીઠું 2kg',        nameHi: 'नमक 2kg',          icon: '🧂', emoji: '🧂', price: 2,  category: 'OIL_ESSENTIALS', giftAidEligible: false, description: 'Table salt 2kg',                unit: '2kg',    imageColor: '#F3F4F6', image: 'https://images.unsplash.com/photo-1596097635121-14b63b7a0c19?w=400&h=250&fit=crop&q=80' },
  { id: 'tea_500',       name: 'Tea (Loose) 500g',      nameGu: 'ચા 500g',          nameHi: 'चाय 500g',         icon: '🍵', emoji: '🍵', price: 5,  category: 'OIL_ESSENTIALS', giftAidEligible: false, description: 'Loose leaf tea 500g',            unit: '500g',   imageColor: '#D6B27040', image: 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?w=400&h=250&fit=crop&q=80' },
  { id: 'biscuits',      name: 'Biscuits (Assorted)',   nameGu: 'બિસ્કિટ',          nameHi: 'बिस्कुट',          icon: '🍪', emoji: '🍪', price: 4,  category: 'OIL_ESSENTIALS', giftAidEligible: false, description: 'Assorted biscuit pack',          unit: 'pack',   imageColor: '#FEF3C7', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=250&fit=crop&q=80' },
  { id: 'milk_powder',   name: 'Milk Powder 400g',      nameGu: 'દૂધ પાવડર',        nameHi: 'दूध पाउडर',        icon: '🥛', emoji: '🥛', price: 7,  category: 'OIL_ESSENTIALS', giftAidEligible: false, description: 'Full fat milk powder 400g',      unit: '400g',   imageColor: '#EFF6FF', image: 'https://images.unsplash.com/photo-1563636619-e9143da7973b?w=400&h=250&fit=crop&q=80' },
  { id: 'tinned_tomatoes',name:'Tinned Tomatoes (6 pack)',nameGu:'ટિન ટામેટા',      nameHi: 'टिन टमाटर',       icon: '🍅', emoji: '🍅', price: 5,  category: 'OIL_ESSENTIALS', giftAidEligible: false, description: 'Chopped tinned tomatoes 6 pack', unit: '6 pack', imageColor: '#FEE2E2', image: 'https://images.unsplash.com/photo-1546548970-71785318a17b?w=400&h=250&fit=crop&q=80' },
  // Pulses
  { id: 'chana_5',  name: 'Chana Daal 5kg',  nameGu: 'ચણા દાળ 5kg',  nameHi: 'चना दाल 5kg',   icon: '🫘', emoji: '🫘', price: 10, category: 'PULSES', giftAidEligible: false, description: 'Split chana daal 5kg',  unit: '5kg', imageColor: '#FEF9C3', image: 'https://images.unsplash.com/photo-1515543904379-3d757afe72e4?w=400&h=250&fit=crop&q=80' },
  { id: 'toor_5',   name: 'Toor Daal 5kg',   nameGu: 'તુવેર દાળ 5kg', nameHi: 'तुअर दाल 5kg',  icon: '🫘', emoji: '🫘', price: 12, category: 'PULSES', giftAidEligible: false, description: 'Split toor daal 5kg',   unit: '5kg', imageColor: '#FEF3C7', image: 'https://images.unsplash.com/photo-1515543904379-3d757afe72e4?w=400&h=250&fit=crop&q=80' },
  { id: 'masoor_5', name: 'Masoor Daal 5kg', nameGu: 'મસૂર દાળ 5kg',  nameHi: 'मसूर दाल 5kg',  icon: '🫘', emoji: '🫘', price: 9,  category: 'PULSES', giftAidEligible: false, description: 'Red lentils 5kg',       unit: '5kg', imageColor: '#FED7AA', image: 'https://images.unsplash.com/photo-1515543904379-3d757afe72e4?w=400&h=250&fit=crop&q=80' },
  { id: 'urad_5',   name: 'Urad Daal 5kg',   nameGu: 'અડદ દાળ 5kg',   nameHi: 'उड़द दाल 5kg',  icon: '🫘', emoji: '🫘', price: 11, category: 'PULSES', giftAidEligible: false, description: 'Split black urad daal 5kg',unit:'5kg', imageColor: '#E5E7EB', image: 'https://images.unsplash.com/photo-1515543904379-3d757afe72e4?w=400&h=250&fit=crop&q=80' },
]
