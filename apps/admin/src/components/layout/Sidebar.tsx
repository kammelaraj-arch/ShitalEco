...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/finance/purchase-orders',   icon: '📦', label: 'Purchase Orders' },
      { href: '/finance/purchase-invoices', icon: '🧾', label: 'Bills (Purchase Invoices)' },
      { href: '/finance/sales-invoices',    icon: '💷', label: 'Sales Invoices (hall hire / fees)' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/media',             icon: '🖼️', label: 'Image Library' },
