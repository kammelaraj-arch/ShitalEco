...
type Role = 'CHAIR' | 'TREASURER' | 'SECRETARY' | 'TRUSTEE'
              ...
              {items.map(t => (
                <tr key={t.id} className="border-b border-white/5 hover:bg-white/5">
                  ...
                  <td className="px-4 py-3">
                    <span className={`px-2 py-0.5 rounded-full text-xs font-bold border ${ROLE_BADGES[t.role]}`}>
                      {t.role}
                    </span>
                  </td>
              ...
              <div className="flex-1 overflow-y-auto px-6 py-5 space-y-4">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {(['CHAIR', 'TREASURER', 'SECRETARY', 'TRUSTEE'] as Role[]).map(r => (
