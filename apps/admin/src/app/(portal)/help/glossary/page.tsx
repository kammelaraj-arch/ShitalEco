...
const SECTIONS: GlossarySection[] = [
  {
    ...
    rows: [
      ...
      { key: 'OPERATIONAL',     label: 'Operational',
        description: 'Day-to-day running improvements that keep the charity functioning. Usually unrestricted funds, modest budgets, no asset created.',
        examples: 'Improve weekly rota process · Move filing to SharePoint · Standardise donation receipts · Migrate from spreadsheets to ERP' },
      { key: 'FUNDRAISING',     label: 'Fundraising',
        description: 'A campaign whose goal is raising money — not delivering services with it. Track pledged vs received vs cost-to-raise.',
        examples: 'Diwali appeal · 100 Pillars sponsorship campaign · Christmas Big Give matching · Major-donor capital appeal' },
      { key: 'TECHNOLOGY',      label: 'Technology',
        description: 'Software / digital infrastructure work. Internal tools, websites, integrations. Treat as CAPITAL only if the spend creates a long-life asset.',
        examples: 'Build the ERP · Rebuild donations website · Integrate Stripe Terminal · Set up Microsoft 365 tenancy' },
      { key: 'MAINTENANCE',     label: 'Maintenance',
        description: 'Repairs, upkeep, BAU fixes. Spend is expensed (not capitalised) and recurring is expected.',
        examples: 'Boiler service · Roof leak repair · Annual PAT testing · Annual safeguarding refresh' },
      { key: 'TRAINING',        label: 'Training',
        description: 'Staff or volunteer skill development. Output is people-capability, not deliverables.',
        examples: 'Trustee induction programme · Food-hygiene certification for kitchen volunteers · Stripe Terminal training for branch managers' },
      { key: 'MARKETING',       label: 'Marketing',
        description: 'Awareness, comms, brand. Distinct from FUNDRAISING — the goal is reach, not money. Often the cost line under a fundraising campaign.',
        examples: 'Refresh charity branding · Local press campaign for new branch opening · Social-media content plan · Print bilingual leaflets' },
      { key: 'RESEARCH',        label: 'Research',
        description: 'Studies, feasibility, surveys. Output is evidence + a decision, not a deliverable.',
        examples: 'Feasibility study for a new branch · Beneficiary needs survey · Cost-benefit analysis on a hall extension' },
      { key: 'PARTNERSHIP',     label: 'Partnership',
        description: 'Joint initiative with another organisation (other temple, council, NHS, school). Both parties have skin in the game.',
        examples: 'Joint food-bank with St James church · NHS wellbeing hub partnership · Schools-engagement pilot with the council' },
      { key: 'EMERGENCY',       label: 'Emergency',
        description: 'Urgent response — disaster relief, crisis support. Often relaxed normal approvals; explicit emergency-fund authorisation.',
        examples: 'Turkey-Syria earthquake relief · Local flood-victim hot meals · Cost-of-living winter heating support' },
      { key: 'COMPLIANCE',      label: 'Compliance',
        description: 'Audit, regulatory, governance. Driven by external requirement (Charity Commission, ICO, HMRC) rather than charity strategy.',
        examples: 'Annual independent examination · GDPR / data protection review · Charity Commission serious-incident report · Gift Aid claim audit' },
    ],
  },
  {
    id: 'fund-type',
