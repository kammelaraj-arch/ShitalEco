        ...
        <div className="flex items-start justify-between flex-wrap gap-3">
          <div>
            ...
            <p className="text-white/40 text-sm mt-1">
              ...
              {summary.parent_project_name && <> · child of <Link href={`/finance/projects/${summary.parent_project_id}`} className="text-saffron-300 hover:underline">{summary.parent_project_name}</Link></>}
            </p>
          ...
          <div>
            ...
            <div className="flex gap-2 flex-wrap">
              {summary.sub_projects.map(c => (
                <Link key={c.id} href={`/finance/projects/${c.id}`}
